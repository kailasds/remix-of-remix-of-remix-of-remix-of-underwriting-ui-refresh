...
export const dataSourcesTab = {
  ...
  sources: [
    { name: "Verisk / ISO", type: "Protection class & construction rating", lastUpdated: "2026-01-08", coverage: "High confidence", status: "Verified", icon: "shield", tone: "electric" },
    { name: "CoreLogic", type: "Replacement cost & construction model", lastUpdated: "2026-02-02", coverage: "±3% RCV confidence", status: "Verified", icon: "dollar", tone: "leaf" },
    { name: "FEMA Flood Map Service", type: "Flood zone & base flood elevation", lastUpdated: "2024-03-01", coverage: "Parcel-level", status: "Verified", icon: "droplet", tone: "electric" },
    { name: "AIR Worldwide", type: "Wind, hurricane & flood CAT modelling", lastUpdated: "2026-01-14", coverage: "1-in-100 / 1-in-250 return periods", status: "Verified", icon: "cloud", tone: "coral" },
    { name: "USGS", type: "Seismic hazard & fault mapping", lastUpdated: "2023-11-14", coverage: "Regional", status: "Verified", icon: "waves", tone: "coral" },
    { name: "Nearmap", type: "Aerial & satellite imagery", lastUpdated: "2026-01-14", coverage: "Full parcel + 300 ft buffer", status: "Verified", icon: "satellite", tone: "iris" },
    { name: "D&B", type: "Business credit report", lastUpdated: "2026-01-20", coverage: "PAYDEX 82", status: "Verified", icon: "trending", tone: "leaf" },
    { name: "LexisNexis Accurint", type: "Principal & entity screening", lastUpdated: "2026-01-19", coverage: "OFAC / PEP / adverse media", status: "Verified", icon: "users", tone: "amber" },
    { name: "Chubb (prior carrier)", type: "5-year loss run history", lastUpdated: "2026-01-05", coverage: "2020 – 2025", status: "Verified", icon: "history", tone: "amber" },
    { name: "FL SunBiz", type: "Entity registration & good-standing", lastUpdated: "2026-01-02", coverage: "Record L15000091823", status: "Verified", icon: "building", tone: "electric" },
    { name: "Insured Submission", type: "ACORD 125 / 140, SOV, appraisal", lastUpdated: "2025-11-01", coverage: "14 documents · 312 fields", status: "Review — SOV stale", icon: "file", tone: "smoke" },
  ],
};
...
export const satelliteImageryTab = {
  ...
  observations: [
    { label: "Roof surface — uniform TPO membrane", detail: "No ponding, debris or membrane damage observed, consistent with the 2026 re-coating.", severity: "good" as const, icon: "home" },
    { label: "Loading dock & drainage", detail: "Dock lighting, bollards and drainage are all present and functioning.", severity: "good" as const, icon: "package" },
    { label: "Rooftop refrigeration units", detail: "Condenser and compressor units appear well-maintained with no visible corrosion.", severity: "good" as const, icon: "snowflake" },
    { label: "Perimeter fencing & lighting", detail: "Fencing and security lighting are intact around the full site perimeter.", severity: "good" as const, icon: "lock" },
    { label: "Vegetation — northeast fence line", detail: "Minor vegetation growth along the fence line; recommend routine trim, not a material exposure.", severity: "watch" as const, icon: "tree" },
    { label: "Adjacent parcel", detail: "Paved surface lot to the east — no exposure amplification from neighboring occupancies.", severity: "good" as const, icon: "map-pin" },
  ],
};
