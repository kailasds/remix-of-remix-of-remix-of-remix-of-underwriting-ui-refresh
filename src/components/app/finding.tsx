      ...
      <div className={`${m.soft} px-5 py-4`}>
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            {eyebrow && <div className="text-[10.5px] font-semibold uppercase tracking-[0.16em] text-fog">{eyebrow}</div>}
    ...
    <div className="rounded-2xl border border-mist/70 bg-white p-4">
      ...
      {answer && (
        <div className="mt-3 rounded-xl bg-ice/40 border border-electric/20 px-3 py-2.5 text-[12.5px] leading-relaxed text-ink animate-fade-up">
          <div className="flex items-center gap-1.5 text-[10.5px] uppercase tracking-wider text-electric font-semibold mb-1"><Sparkles className="h-3 w-3" /> AI</div>
          {answer}
        </div>
      )}
    </div>
